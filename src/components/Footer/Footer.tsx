...
export default function Footer() {
  ...
  return (
    // <footer className="footer text-center p-2 bg-base-300 text-base-content">
    //   <aside className="items-center text-neutral-content grid-flow-col text-[10px]">
    ...
    <footer className=" text-white mx-auto flex flex-col gap-5 justify-betwee items-center">
      <div className="mt-4">
        <h2 className="text-2xl font-bold">Code spase</h2>
      </div>
      <div className="">
      ...
      <div className="flex justify-center gap-5">
        ...
        <a href="#">
          <i className="bi bi-facebook opacity-90 hover:opacity-100" />
        </a>
        <a href="#">
          <i className="bi bi-github opacity-90 hover:opacity-100" />
        </a>
      </div>
