      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:px-10  lg:pt-5">
        <div className="flex flex-1 flex-col p-5 text-center">
          <h3 className="my-0">
            ...
            <br /> mastering <span className="text-primary">
              social media
            </span>{" "}
            for businesses
          </h3>
		  ...
		  <button className="btn lg:btn-md btn-sm btn-secondary text-white">Glass button</button>
		  <button className="btn lg:btn-sm btn-xs btn-outline btn-secondary hover:!text-white">Glass button</button>
		  </div>
        </div>
