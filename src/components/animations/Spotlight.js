...
export default function Spotlight() {
  return (
    <Canvas className='animation' shadows gl={{ alpha: false, antialias: false }} camera={{ fov: 75, position: [0, 0, 60], near: 10, far: 150 }}>
    <color attach="background" args={['#450042']} />
    <fog attach="fog" args={['#450042']} />
    <ambientLight intensity={1.2} />
    <pointLight position={[100, 10, -50]} intensity={20} castShadow />
    <pointLight position={[-100, -100, -500]} intensity={0} color="blue" />
    <Swarm count={500} position={[0, 10, 0]} />
    <ContactShadows rotation={[Math.PI / 2, 0, 0]} position={[0, -30, 0]} opacity={0.5} width={800} height={150} blur={1} far={90} />
